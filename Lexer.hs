...
alex_base = Data.Array.listArray (0 :: Int, 140)
  [ -8
  , 77
  , 161
  , 245
...
alex_table = Data.Array.listArray (0 :: Int, 11253)
  [ 0
  , 70
  , 70
  , 70
...
alex_check = Data.Array.listArray (0 :: Int, 11253)
  [ -1
  , 9
  , 10
  , 11
...
alex_deflt = Data.Array.listArray (0 :: Int, 140)
  [ -1
  , -1
  , -1
  , -1
...
alex_accept = Data.Array.listArray (0 :: Int, 140)
  [ AlexAccNone
  , AlexAcc 128
  , AlexAcc 127
  , AlexAcc 126
...
alex_action_23 = \p s -> PT p TokenAS
alex_action_24 = \p s -> PT p TokenWITHLABELS
alex_action_25 = \p s -> PT p TokenNOLABELS
alex_action_26 = \p s -> PT p TokenSquigleBracketL
alex_action_27 = \p s -> PT p TokenSquigleBracketR
alex_action_28 = \p s -> PT p TokenComma
alex_action_29 = \p s -> PT p TokenDash
alex_action_30 = \p s -> PT p TokenSquareBracketL
alex_action_31 = \p s -> PT p TokenSquareBracketR
alex_action_32 = \p s -> PT p (TokenInt (read s))
alex_action_33 = \p s -> PT p (TokenVar s)
